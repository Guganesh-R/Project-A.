...
namespace TMS1.Controllers
{
    public class EmployeeInfoController : Controller
    {
        ...
        public EmployeeInfoController(TMS1Context context)
        {
            _context = context;
        }
        ...
        {
            var tMS1Context = _context.EmployeeInfo.Include(e => e.RouteInfo).Include(e => e.VehicleInfo);
        ...
        public async Task<IActionResult> Create([Bind("EmployeeID,EmployeeName,EmployeeAdress,EmployeeAge,VehicleId,RouteId")] EmployeeInfo employeeInfo)
        {
            ...
            ViewData["VehicleId"] = new SelectList(_context.VehicleInfo, "VehicleId", "VehicleId", employeeInfo.VehicleId);
            return View(employeeInfo);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeID,EmployeeName,EmployeeAdress,EmployeeAge,VehicleId,RouteId")] EmployeeInfo employeeInfo)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TMS1Context.EmployeeInfo'  is null.");
            }
            var employeeInfo = await _context.EmployeeInfo.FindAsync(id);
            if (employeeInfo != null)
            {
        ...
        {
          return (_context.EmployeeInfo?.Any(e => e.EmployeeID == id)).GetValueOrDefault();
        }
    }
}
