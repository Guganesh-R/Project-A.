...
namespace TMS1.Controllers
{
    public class RouteInfoController : Controller
    {
        ...
        public RouteInfoController(TMS1Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.RouteInfo != null ? 
                          ...
                          Problem("Entity set 'TMS1Context.RouteInfo'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("RouteId,stop1,stop2")] RouteInfo routeInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RouteId,stop1,stop2")] RouteInfo routeInfo)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TMS1Context.RouteInfo'  is null.");
            }
            var routeInfo = await _context.RouteInfo.FindAsync(id);
            if (routeInfo != null)
            {
